...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100">
      ...
      {/* Hero Section */}
      <section data-aos="fade-up" className="w-full flex flex-col items-center justify-center py-24 px-4 text-center min-h-[60vh] flex-grow bg-green-600">
        <h1 className="text-5xl md:text-6xl font-extrabold text-white mb-4 drop-shadow-lg transition-all duration-500">
          ExZi: Excel Analytics, Reimagined
        </h1>
        <p className="text-xl md:text-2xl text-green-100 mb-8 max-w-2xl mx-auto transition-all duration-500">
          Instantly visualize, analyze, and share your Excel data with beautiful charts and smart insights. No coding required.
        </p>
        <a href="/upload" className="inline-block bg-white text-green-600 border-2 border-green-600 hover:bg-green-50 hover:text-green-700 text-lg font-bold py-4 px-10 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 animate-bounce mt-4" style={{ marginTop: '10px' }}>
      ...
      <section className="max-w-5xl mx-auto py-16 px-4 animate-fadeInDown">
        <h2 data-aos="fade-up" className="text-3xl font-extrabold text-green-700 mb-8 text-center mt-10" style={{ marginTop: '40px' }}>Services we provide</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div data-aos="fade-up" className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center hover:scale-105 transition-transform duration-300">
          ...
          <div data-aos="fade-up" className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center hover:scale-105 transition-transform duration-300 md:col-span-1">
          ...
          <div data-aos="fade-up" className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center hover:scale-105 transition-transform duration-300 md:col-span-2">
      ...
      <section className="max-w-4xl mx-auto py-16 px-4 animate-fadeIn">
        <h2 data-aos="fade-up" className="text-3xl font-extrabold text-green-700 mb-8 text-center">How it Works</h2>
      ...
      <section className="max-w-4xl mx-auto py-16 px-4 animate-fadeInUp">
        <h2 data-aos="fade-up" className="text-3xl font-extrabold text-green-700 mb-8 text-center">Trusted by Data-Lovers</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div data-aos="fade-right" className="bg-white rounded-xl shadow-md p-6 flex flex-col items-center">
          ...
          <div data-aos="fade-left" className="bg-white rounded-xl shadow-md p-6 flex flex-col items-center">
            <FiCheckCircle className="text-3xl text-green-400 mb-2" />
